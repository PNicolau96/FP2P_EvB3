...
%S.geometry='treebranch_geometry';
%S.geometry='treebranch_geometry2';
% S.geometry='treebranch_geometry3';
S.geometry='treebranch_geometry3';
...
% and low for outflow. soureP and sink P were defined above.
...
S.ncombsx  = 8; % number of columns of hexagons, in x direction
S.ncombsy  = 5; % number of rows of hexagons
...
S.ConnectedBottomNodes=[2];  % so a single high P source at the bottom
S.ConnectedTopNodes=[2 ]; % ... and a single exit paths

% Predefine the (initial) radii in the model
% FP2P you might want to take other choices here
%S.r0=80e-6;
...
elseif strcmp(S.geometry,'treebranch_geometry')
%S.r0=80e-6;							% default radius, one of the segments will be made smaller to tip the bridge out of equilibrium
S.sources=[1 0];

elseif strcmp(S.geometry,'treebranch_geometry2')
%S.r0=80e-6;							% default radius, one of the segments will be made smaller to tip the bridge out of equilibrium
S.sources=[1 0];

elseif strcmp(S.geometry,'treebranch_geometry3')
%S.r0=80e-6;							% default radius, one of the segments will be made smaller to tip the bridge out of equilibrium
S.sources=[1 0];
