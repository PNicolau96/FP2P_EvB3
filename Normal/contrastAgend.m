...
hold on
plot(TotConc+TotConc3) % Now average total flow
plot(TotRes+TotRes3) % Now total residence
plot(TotDiff+TotDiff3) % Now total in- outflow
title('Top Selection (Normal)')
xlabel('t [s]')
